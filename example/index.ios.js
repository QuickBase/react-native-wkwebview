    ...
    return (
      <View style={{ flex: 1, marginTop: 20 }}>
        <WKWebView style={{ backgroundColor: '#ff0000' }}
          ...
          injectedJavaScript="window.postMessage('Hello from WkWebView'); document.addEventListener('message', function(e) { alert(e.data); }); setTimeout(function(){alert(document.cookie); console.log(document.cookie);}, 1000);"
        />
